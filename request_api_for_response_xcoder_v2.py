...
import sys
sys.path.insert(0, '/mnt/code/zhaoxudong03/RL/X-Coder-main/rl-recipe/code-judge')
from simple_sanbox_judge import score_single
...
def main(path, start_index=0, end_index=None, client=None, max_retries=5, success_path=None, error_path=None):
    ...
    datas = []
    for elem in tqdm(yield_data(path)):
        datas.append(elem)
...
if __name__ == '__main__':
    ...
    ori_path = '/mnt/code/zhaoxudong03/zxd_datas/X-Coder/generate/xcoder_sandbox_error.jsonl'
    # 验证通过path 和 多次验证失败 path
    success_path = '/mnt/code/zhaoxudong03/zxd_datas/X-Coder/generate/error_5_times/xcoder_sandbox_1time_error_5time_success.jsonl'
    error_path = "/mnt/code/zhaoxudong03/zxd_datas/X-Coder/generate/error_5_times/xcoder_sandbox_1time_error_5time_error.jsonl"
