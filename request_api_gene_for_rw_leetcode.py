...
def get_answer_from_rw_livebench_querys(path, start_index=0):
    ...
    save_path = '/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/leetcode_rw_10_times_gene_res_2507.jsonl'
    questions = []
...
if __name__ == '__main__':
    ...
    get_answer_from_rw_livebench_querys('/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/leetcode_rw_10_times.jsonl')