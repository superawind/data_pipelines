...
# res = get_ans({'prompt': '你好，你谁啊，为什么这呀', 'source':''}, 1)
...
def mul_get(path):
    ...
    for idx in range(0, len(cur_datas), 5000):
        ...
        save_path = '/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/wangfei_prompt_1477w_01_strict_dep_embeded_0-6B.jsonl'
...
if __name__ == '__main__':
    mul_get('/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/wangfei_prompt_zh_01_strict_dup_for_embedding.jsonl')
