...
def get_answer_from_rw_livebench_querys(path, start_index=0):
    ...
    cur_datas = load_dataset("parquet", data_files='/mnt/code/zhaoxudong03/datas/rstar-code-zxd/data-00000-of-00020.parquet', split='train')
    for elem in cur_datas:
    ...
    #         print(file_path)
    #         cur_datas = load_dataset("microsoft/rStar-Coder", data_files='/mnt/code/zhaoxudong03/datas/rStar-Coder/seed_sft/data-00019-of-00020.parquet')
    #         print(cur_datas)
    #         break
    # return 
    # save_path = '/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/am-thinking-code-412k.jsonl'
    save_path = '/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/rstar-code-412k.jsonl'
...
if __name__ == '__main__':
    ...
    # get_answer_from_rw_livebench_querys('/mnt/code/zhaoxudong03/data_pipelines/training_data_zxd/step2/clarity_code_not_over_8_to_10_and_cg_over_8_to_10/Code.jsonl')
    get_answer_from_rw_livebench_querys('/code/zhaoxudong03/datas/rStar-Coder/seed_sft', start_index=0)
